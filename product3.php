      ...
      <div class="row">
        ...
        <div class="col-md-1">
          <button class="btn btn-sm bg-transparent">
            <img width="45px" src="images/eolienne3.jpg" alt="btn image" />
          </button>
          <button class="btn btn-sm bg-transparent">
            <img width="45px" src="images/eolienne3.jpg" alt="btn image" />
          </button>
        ...
        <div class="col-md-4">
          ...
          <h6 class="font-weight-bold">EOLIENNE SLOWMOOSE</h6>
          <p>
          ...
          <p class="mb-0">
            ...
            <span class="text-danger font-weight-bold">1899$ &nbsp;<i class="fas fa-dollar-sign"></i></span>
        ...
        <div class="row border-bottom mt-3">
          <div class="col-md-12 my-3">
           ...
           <p> La capacité solaire par défaut est de 200W, la capacité solaire en option pourrait atteindre 1000W Maximium. </p>
           <p> C'est la reconnaissance automatique du système 12V / 24V. Il dispose de 2 sorties CC, 12A chacune. </p>
           <p> Il a 2 boutons de réglage qui pourraient vérifier et modifier les paramètres du contrôleur. </p>
           <p> (uniquement pour les techniciens expérimentés). Il y a aussi le port TL232. </p>
           <p> Avec un câble (TL232 vers USB), les paramètres du contrôleur peuvent être modifiés sur l’ordinateur .</p>
          </div>
        </div>
